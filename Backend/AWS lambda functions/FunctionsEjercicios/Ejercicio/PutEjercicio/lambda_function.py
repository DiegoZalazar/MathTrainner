...
def lambda_handler(event, context):
    ...
    try:
        ...
        query = f"UPDATE Ejercicio SET (plantamientoEjercicio,resolucionEjercicio,tiempo,tipoEjercicio,nivelEjercio) VALUES (${plantamientoEjercicio}, ${resolucionEjercicio}, ${tiempoEjercicio},${tipoEjercicio},${nivelEjercio}) WHERE idEjercicio= ${idEjercicio} "
